...
export const FileDescriptorSet = {
    encode(message: FileDescriptorSet, writer: pb.Writer = pb.Writer.create()): pb.Writer {
    ...
    decode(input: pb.Reader | Uint8Array, length?: number): FileDescriptorSet {
...
export const FileDescriptorProto = {
    encode(message: FileDescriptorProto, writer: pb.Writer = pb.Writer.create()): pb.Writer {
        if (message.name !== '') {
    ...
    decode(input: pb.Reader | Uint8Array, length?: number): FileDescriptorProto {
        const reader = input instanceof pb.Reader ? input : pb.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
...
export const DescriptorProto = {
    encode(message: DescriptorProto, writer: pb.Writer = pb.Writer.create()): pb.Writer {
        if (message.name !== '') {
            writer.uint32(10).string(message.name);
        }
    ...
    decode(input: pb.Reader | Uint8Array, length?: number): DescriptorProto {
        const reader = input instanceof pb.Reader ? input : pb.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
...
export const DescriptorProto_ExtensionRange = {
    encode(message: DescriptorProto_ExtensionRange, writer: pb.Writer = pb.Writer.create()): pb.Writer {
        if (message.start !== 0) {
    ...
    decode(input: pb.Reader | Uint8Array, length?: number): DescriptorProto_ExtensionRange {
        const reader = input instanceof pb.Reader ? input : pb.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
...
export const DescriptorProto_ReservedRange = {
    encode(message: DescriptorProto_ReservedRange, writer: pb.Writer = pb.Writer.create()): pb.Writer {
        if (message.start !== 0) {
            writer.uint32(8).int32(message.start);
        }
        if (message.end !== 0) {
    ...
    decode(input: pb.Reader | Uint8Array, length?: number): DescriptorProto_ReservedRange {
        const reader = input instanceof pb.Reader ? input : pb.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
...
export const ExtensionRangeOptions = {
    encode(message: ExtensionRangeOptions, writer: pb.Writer = pb.Writer.create()): pb.Writer {
    ...
    decode(input: pb.Reader | Uint8Array, length?: number): ExtensionRangeOptions {
        const reader = input instanceof pb.Reader ? input : pb.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
...
export const FieldDescriptorProto = {
    encode(message: FieldDescriptorProto, writer: pb.Writer = pb.Writer.create()): pb.Writer {
        if (message.name !== '') {
            writer.uint32(10).string(message.name);
        }
        if (message.number !== 0) {
    ...
    decode(input: pb.Reader | Uint8Array, length?: number): FieldDescriptorProto {
        const reader = input instanceof pb.Reader ? input : pb.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
...
export const OneofDescriptorProto = {
    encode(message: OneofDescriptorProto, writer: pb.Writer = pb.Writer.create()): pb.Writer {
        if (message.name !== '') {
            writer.uint32(10).string(message.name);
        }
        if (message.options !== undefined) {
    ...
    decode(input: pb.Reader | Uint8Array, length?: number): OneofDescriptorProto {
        const reader = input instanceof pb.Reader ? input : pb.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
...
export const EnumDescriptorProto = {
    encode(message: EnumDescriptorProto, writer: pb.Writer = pb.Writer.create()): pb.Writer {
        if (message.name !== '') {
            writer.uint32(10).string(message.name);
        }
    ...
    decode(input: pb.Reader | Uint8Array, length?: number): EnumDescriptorProto {
        const reader = input instanceof pb.Reader ? input : pb.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
...
export const EnumDescriptorProto_EnumReservedRange = {
    encode(message: EnumDescriptorProto_EnumReservedRange, writer: pb.Writer = pb.Writer.create()): pb.Writer {
        if (message.start !== 0) {
            writer.uint32(8).int32(message.start);
        }
        if (message.end !== 0) {
    ...
    decode(input: pb.Reader | Uint8Array, length?: number): EnumDescriptorProto_EnumReservedRange {
        const reader = input instanceof pb.Reader ? input : pb.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
...
export const EnumValueDescriptorProto = {
    encode(message: EnumValueDescriptorProto, writer: pb.Writer = pb.Writer.create()): pb.Writer {
        if (message.name !== '') {
            writer.uint32(10).string(message.name);
        }
        if (message.number !== 0) {
    ...
    decode(input: pb.Reader | Uint8Array, length?: number): EnumValueDescriptorProto {
        const reader = input instanceof pb.Reader ? input : pb.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
...
export const ServiceDescriptorProto = {
    encode(message: ServiceDescriptorProto, writer: pb.Writer = pb.Writer.create()): pb.Writer {
        if (message.name !== '') {
            writer.uint32(10).string(message.name);
        }
    ...
    decode(input: pb.Reader | Uint8Array, length?: number): ServiceDescriptorProto {
        const reader = input instanceof pb.Reader ? input : pb.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
...
export const MethodDescriptorProto = {
    encode(message: MethodDescriptorProto, writer: pb.Writer = pb.Writer.create()): pb.Writer {
        if (message.name !== '') {
            writer.uint32(10).string(message.name);
        }
    ...
    decode(input: pb.Reader | Uint8Array, length?: number): MethodDescriptorProto {
        const reader = input instanceof pb.Reader ? input : pb.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
...
export const FileOptions = {
    encode(message: FileOptions, writer: pb.Writer = pb.Writer.create()): pb.Writer {
    ...
    decode(input: pb.Reader | Uint8Array, length?: number): FileOptions {
        const reader = input instanceof pb.Reader ? input : pb.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
...
export const MessageOptions = {
    encode(message: MessageOptions, writer: pb.Writer = pb.Writer.create()): pb.Writer {
    ...
    decode(input: pb.Reader | Uint8Array, length?: number): MessageOptions {
        const reader = input instanceof pb.Reader ? input : pb.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
...
export const FieldOptions = {
    encode(message: FieldOptions, writer: pb.Writer = pb.Writer.create()): pb.Writer {
        if (message.ctype !== 0) {
    ...
    decode(input: pb.Reader | Uint8Array, length?: number): FieldOptions {
        const reader = input instanceof pb.Reader ? input : pb.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
...
export const OneofOptions = {
    encode(message: OneofOptions, writer: pb.Writer = pb.Writer.create()): pb.Writer {
        for (const v of message.uninterpretedOption) {
            UninterpretedOption.encode(v!, writer.uint32(7994).fork()).ldelim();
        }
        return writer;
    ...
    decode(input: pb.Reader | Uint8Array, length?: number): OneofOptions {
        const reader = input instanceof pb.Reader ? input : pb.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
...
export const EnumOptions = {
    encode(message: EnumOptions, writer: pb.Writer = pb.Writer.create()): pb.Writer {
    ...
    decode(input: pb.Reader | Uint8Array, length?: number): EnumOptions {
        const reader = input instanceof pb.Reader ? input : pb.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
...
export const EnumValueOptions = {
    encode(message: EnumValueOptions, writer: pb.Writer = pb.Writer.create()): pb.Writer {
        if (message.deprecated === true) {
    ...
    decode(input: pb.Reader | Uint8Array, length?: number): EnumValueOptions {
        const reader = input instanceof pb.Reader ? input : pb.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
...
export const ServiceOptions = {
    encode(message: ServiceOptions, writer: pb.Writer = pb.Writer.create()): pb.Writer {
        if (message.deprecated === true) {
    ...
    decode(input: pb.Reader | Uint8Array, length?: number): ServiceOptions {
        const reader = input instanceof pb.Reader ? input : pb.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
...
export const MethodOptions = {
    encode(message: MethodOptions, writer: pb.Writer = pb.Writer.create()): pb.Writer {
        if (message.deprecated === true) {
            writer.uint32(264).bool(message.deprecated);
        }
    ...
    decode(input: pb.Reader | Uint8Array, length?: number): MethodOptions {
        const reader = input instanceof pb.Reader ? input : pb.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
...
export const UninterpretedOption = {
    encode(message: UninterpretedOption, writer: pb.Writer = pb.Writer.create()): pb.Writer {
    ...
    decode(input: pb.Reader | Uint8Array, length?: number): UninterpretedOption {
        const reader = input instanceof pb.Reader ? input : pb.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
...
export const UninterpretedOption_NamePart = {
    encode(message: UninterpretedOption_NamePart, writer: pb.Writer = pb.Writer.create()): pb.Writer {
        if (message.namePart !== '') {
    ...
    decode(input: pb.Reader | Uint8Array, length?: number): UninterpretedOption_NamePart {
        const reader = input instanceof pb.Reader ? input : pb.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
...
export const SourceCodeInfo = {
    encode(message: SourceCodeInfo, writer: pb.Writer = pb.Writer.create()): pb.Writer {
    ...
    decode(input: pb.Reader | Uint8Array, length?: number): SourceCodeInfo {
        const reader = input instanceof pb.Reader ? input : pb.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
...
export const SourceCodeInfo_Location = {
    encode(message: SourceCodeInfo_Location, writer: pb.Writer = pb.Writer.create()): pb.Writer {
    ...
    decode(input: pb.Reader | Uint8Array, length?: number): SourceCodeInfo_Location {
        const reader = input instanceof pb.Reader ? input : pb.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
...
export const GeneratedCodeInfo = {
    encode(message: GeneratedCodeInfo, writer: pb.Writer = pb.Writer.create()): pb.Writer {
    ...
    decode(input: pb.Reader | Uint8Array, length?: number): GeneratedCodeInfo {
        const reader = input instanceof pb.Reader ? input : pb.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
...
export const GeneratedCodeInfo_Annotation = {
    encode(message: GeneratedCodeInfo_Annotation, writer: pb.Writer = pb.Writer.create()): pb.Writer {
        writer.uint32(10).fork();
        for (const v of message.path) {
            writer.int32(v);
        }
    ...
    decode(input: pb.Reader | Uint8Array, length?: number): GeneratedCodeInfo_Annotation {
        const reader = input instanceof pb.Reader ? input : pb.Reader.create(input);
        let end = length === undefined ? reader.len : reader.pos + length;
